...
describe('Reports', () => {
  ...
  describe('Portfolio Report', () => {
    test('should get a portfolio report', () => {
      ...
      return Reports.getPortfolio({ teamId: 'bestteam' })
        .then(response => {
          expect(response).to.not.be.a('error')

          expect(response.project_summaries.length).to.equal(expectedPortfolioReportResponse.project_summaries.length)
          expect(response.project_status_summaries.length).to.equal(expectedPortfolioReportResponse.project_status_summaries.length)
          expect(response.vulnerability_summaries.length).to.equal(expectedPortfolioReportResponse.vulnerability_summaries.length)
        })
    })
  })
  ...
  describe('Vulnerability Mitigation Report', () => {
    test('should get a vulnerability mitigation report', () => {
      ...
      return Reports.getVulnerabilityList({ teamId: 'bestteam' })
        .then(resp => {
          expect(resp.cve_list.length).to.equal(expectedVulnListReportResponse.cve_list.length)
          ...
          axes: [
            {
              ...
              orientation: 'left',
              points: [ 7, 0, 17, 0, 7, 7, 10, 0, 1, 13, 13, 16, 10, 1, 5, 49, 13, 3, 12, 16, 11, 0, 0, 2, 5, 3, 13 ],
            },
            {
              legend: 'projects analyzed',
              orientation: 'right',
              points: [ 11, 11, 1, 11, 10, 11, 11, 11, 11, 11, 11, 11, 1, 11, 1, 11, 11, 11, 11, 11, 11, 11, 10, 11, 1, 11, 11 ],
            },
          ],
          lines: [
            {
...
const expectedVulnListReportResponse = {
  cve_list: [
    { title: 'CVE-2019-10744', projects_affected: 1, product: 'lodash', rating: 9.8, system: 'cvssv3' },
    { title: 'CVE-2016-10697', projects_affected: 1, product: 'react-native-baidu-voice-synthesizer', rating: 8.1, system: 'cvssv3' },
    { title: 'NPM-1164', projects_affected: 1, product: 'handlebars', rating: 7, system: 'cvssv3' },
    { title: 'NPM-1070', projects_affected: 1, product: 'lodash.defaultsdeep', rating: 7, system: 'cvssv3' },
    { title: 'NPM-1068', projects_affected: 1, product: 'lodash.defaultsdeep', rating: 7, system: 'cvssv3' },
    { title: 'NPM-1065', projects_affected: 1, product: 'lodash', rating: 7, system: 'cvssv3' },
    { title: 'NPM-1300', projects_affected: 1, product: 'handlebars', rating: 5, system: 'cvssv3' },
    { title: 'CVE-2019-11284', projects_affected: 1, product: 'reactor_netty', rating: 5, system: 'cvssv2' },
  ],
}
