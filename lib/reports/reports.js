...
export class Reports {
  static getAnalysis({ projectId, teamId, analysisId, isAdmin = false }) {
    ...
    const endpoint = isAdmin ? getAnalysisEndpointV2 : getAnalysisEndpoint
...
const getAnalysisEndpointV2 = '/v1/report/getAnalysis2'
