...
- methods
  ...
  - `getAnalysis`
    ...
    - returns: Promise
      - data: object
        - analysis: `Analysis`
      - example: look at line 306 in [test file](lib/reports/reports.test.js)
    - example:
    ```javascript
    Reports.getAnalysis({
  ...
  - `getDigests`
    ...
    - returns: Promise
      - data: object
        - data: object
          - `Digests`
      - [example](lib/reports/reports.test.js) line 49
    - example:
    ```javascript
    Reports.getDigests({
      projectId: 'someproject',
  ...
  - `getProject`
    ...
    - returns: Promise, see [example](lib/reports/reports.test.js) line 852
    - example:
    ```javascript
    Reports.getProject({
      projectId: 'someproject',
  ...
  - `getProjects`
    ...
    - returns: Promise
      ...
      - meta: `Meta`
      - [example](lib/reports/reports.test.js) line 916
  ...
  - `getPortfolio`
    ...
    - returns: Promise
      ...
      - [example](lib/reports/repots.test.js) line 35374
  ...
  - `getVulnerabilityList`
    ...
    - returns: Promise
      ...
      - [example](lib/reports/reports.test.js) line 35828
  ...
  - `getAffectedProjects`
    ...
    - parameter: object
      ...
      - [example](lib/reports/reports.test.js) line 35889
  ...
  - `getProjectHistory`
    ...
    - returns: Promise that resovles to an array of `ProjectStatus`
      - [example](lib/reports/reports.test.js) line 34488
  ...
  - `getExportedData`
    ...
    - returns: Promise
      ...
      - [example](lib/reports/reports.test.js) line 34571
  ...
  - `getProjectsByDependency`
    ...
    - returns: Promise
      ...
      - meta: `Meta`
        [example](lib/reports/reports.test.js) line 34618
    - example:
    ```javascript
