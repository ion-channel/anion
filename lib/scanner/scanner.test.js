  ...
  describe('analyzeProjects', () => {
    test('should return a success response', () => {
      const response = {
        data: {
          succeeded: [
            { id: '95dc4e15-3f44-4651-b889-1dfd29ed344d' },
            { id: '9657f3fe-2cce-4054-8e1b-5ec40b246db1' },
          ],
          failed: [],
        },
      }
      nock('http://localhost:8001')
        .matchHeader('Authorization', 'bearer soopersecret')
        .post('/v1/scanner/analyzeProjects', [
          { project_id: '95dc4e15-3f44-4651-b889-1dfd29ed344d' },
          { project_id: '9657f3fe-2cce-4054-8e1b-5ec40b246db1' },
        ])
        .reply(200, response)
      return Scanner.analyzeProjects([
        { project_id: '95dc4e15-3f44-4651-b889-1dfd29ed344d' },
        { project_id: '9657f3fe-2cce-4054-8e1b-5ec40b246db1' },
      ]).then(res => {
