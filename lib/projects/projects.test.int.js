...
describe('Projects', () => {
  ...
  describe('GetProject', () => {
    ...
    test('should get a project', () => {
      return Projects.getProject({ id: '8ca10aea-7451-4fba-920e-e0abab735071', teamId: 'bbd16a1b-05b5-40f8-9bc8-b3e8fcf9116c' })
        .then(projectResp => {
    ...
    test('should return an error on a not found', () => {
      return Projects.getProject({ id: 'cd98e4e1-6926-4989-8ef8-f326cd5956fc' })
        .catch(response => {
    ...
    test('should get a users projects', () => {
      return Sessions.login('ion', 'channel')
        .then(session => {
          ...
          return Projects.getProjects({ teamId: 'bbd16a1b-05b5-40f8-9bc8-b3e8fcf9116c' })
            .then(projectsResp => {
