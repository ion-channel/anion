...
export class Projects {
  ...
  static updateProject({ project, checkAccess = false }) {
    ...
    return Put(updateProjectEndpoint, params, Auth.appendHeaders(), project)
      .then(({ data }) => {
        Structs.Project(data.data)
        return data.data
      })
...
const getPublicProjectEndpoint = 'v1/project/getPublicProject'
const getProjectsEndpoint = 'v1/project/getProjects'
const updateProjectEndpoint = 'v1/project/updateProject'
const updateRulesetForProjectsEndpoint = '/v1/project/updateRulesetForProjects'
