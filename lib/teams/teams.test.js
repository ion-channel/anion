...
describe('Teams', () => {
  ...
  describe('Get Invite', () => {
    test('should get an invite', () => {
      nock('http://localhost:8001')
        .matchHeader('Authorization', 'aninvitetoken')
        .get('/v1/teamUsers/getInvite?someid=inviteid')
        .reply(200, {
          id: 'inviteid',
          team_id: '26cc214c-5cab-43c9-8249-43bb9c916920',
          team_name: 'best team',
        })

      return Teams.getInvite({
        id: 'inviteid',
        token: 'aninvitetoken',
      }).then(resp => {
        expect(resp.team_name).toEqual('best team')
      })
    })
  })
  ...
  describe('GetTeam', () => {
    ...
    test('should return an error on a not found', () => {
      ...
      return Teams.getTeam({
        ...
        expect(response.message).toEqual('Request failed with status code 423')
      })
    })
  ...
  describe('Update Team', () => {
    test('should update a team', () => {
      ...
      nock('http://localhost:8001')
        .matchHeader('Authorization', 'bearer soopersecret')
        .put(
          '/v1/teams/updateTeam?id=cd98e4e1-6926-4989-8ef8-f326cd5956fc',
          expectedBody,
        )
        .reply(200, expectedRes)
  ...
  describe('Update Team User', () => {
    test('should update the role of a user on a team', () => {
      ...
      const data = {
        id: someid,
        created_at: '2019-03-19T16:26:12.955Z',
        updated_at: '2020-02-24T19:19:24.692Z',
        team_id: '1ec3754c-b6d0-4ee3-bc8b-2c929cf97934',
        user_id: '72703033-e379-4b9b-9fb1-fb41467b80bf',
        role: 'admin',
        deleted_at: null,
        status: 'active',
        inviter: 'f8636445-a1ab-434b-87ef-329ab7aba37e',
        invited_at: '2019-03-19T16:26:12.955Z',
        username: 'foo',
        email: 'foos@bar.com',
        chat_handle: null,
        last_active_at: '2020-02-24T18:52:27.708Z',
      }
      const expectedRes = {
        data,
        meta: {
