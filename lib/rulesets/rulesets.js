...
export class Rulesets {
  ...
  static getStatusesHistory(ids) {
    return Post(getStatuesHistoryEndpoint, undefined, Auth.appendHeaderes(), {
      ids,
    })
  }
}
...
const getStatuesHistoryEndpoint = '/v1/ruleset/getStatusesHistory'
